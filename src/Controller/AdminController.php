...
class AdminController extends AbstractController
{
    ...
    /**
     * @Route("/admin/user/profil-{byId}", name="_update_user")
     ...
     *
     * /**
     * @Route("admin/user/remove/{id}", name="remove_user_")
    ...
    (Conference $conference, EntityManagerInterface $entityManager, LoggerInterface $logger)
    {
        ...
        $entityManager->flush();
        $logger->info('Conference removed ! User email :' . $this->getUser()->getEmail() . ', name :' . $conference->getName() . ', id :' . $conference->getId());
        $this->addFlash('success', 'Conference removed !');
        return $this->redirectToRoute('home');
    }

    /**
     * @Route("/admin/conference/profil-{byId}", name="update_conference")
     * @ParamConverter("conference", options={"mapping"={"byId"="id"}})
     */
    public function updateConference(Request $request, Conference $conference, EntityManagerInterface $entityManager)
    {
